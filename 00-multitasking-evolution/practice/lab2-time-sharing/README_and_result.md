...
```
ขนาดที่เหมาะสมคือ ไม่สั้นเกินไปและไม่ยาวเกินไป โดยทั่วไปจะอยู่ในช่วง 10–100 มิลลิวินาที
```
2. ปัญหาอะไรที่เกิดขึ้นเมื่อ time slice สั้นเกินไป?
```
เกิด context switching บ่อย ทำให้ เสียเวลาส่วนใหญ่ไปกับการสลับงานมากกว่าทำงานจริง
```
3. ปัญหาอะไรที่เกิดขึ้นเมื่อ time slice ยาวเกินไป?
```
งาน interactive เช่น กดคีย์บอร์ด/เมาส์ ตอบสนองช้า
```
4. Context switching overhead คิดเป็นกี่เปอร์เซ็นต์ของเวลาทั้งหมด?
```
time slice สั้นมาก overhead อาจพุ่งขึ้น 10%–30% 
```
5. งานไหนที่ได้รับผลกระทบมากที่สุดจากการ time-sharing?
```
งานที่ CPU-bound สั้น ๆ → ถ้า time slice ยาวเกินจะต้องรอนานเกินไป
```

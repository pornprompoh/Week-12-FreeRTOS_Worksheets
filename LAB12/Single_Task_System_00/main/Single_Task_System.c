...
void app_main(void)
{
    ...
    ESP_LOGI("MAIN", "1. Cooperative");
    ESP_LOGI("MAIN", "2. Preemptive");

    // เลือกโหมดที่จะรันได้ตรงนี้:
    // test_cooperative_multitasking();   // Cooperative
    test_preemptive_multitasking();       // Preemptive
}
